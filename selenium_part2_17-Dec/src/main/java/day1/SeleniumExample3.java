...
public class SeleniumExample3 {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("MainContent_txtFirstName")).sendKeys("Vinay");
		driver.findElement(By.id("MainContent_txtEmail")).sendKeys("vinay@gmail.com");
		driver.findElement(By.id("MainContent_txtHomePhone")).sendKeys("7406130080");
		driver.findElement(By.id("MainContent_txtPassword")).sendKeys("vinay");
		driver.findElement(By.id("MainContent_txtVerifyPassword")).sendKeys("vinay");
